 ...
 */
final class Version20181010164206 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD description LONGTEXT DEFAULT NULL, CHANGE alt title VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP description, CHANGE title alt VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}

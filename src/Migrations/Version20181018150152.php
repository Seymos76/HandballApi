 ...
 */
final class Version20181018150152 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD convocation DATETIME DEFAULT NULL, ADD appointment_location VARCHAR(255) NOT NULL, ADD appointment_date DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game DROP convocation, DROP appointment_location, DROP appointment_date');
    }
}

...
class TrainingCategoryController extends AbstractController
{
    ...
    {
        return $this->render('training_category/index.html.twig', ['training_categories' => $trainingCategoryRepository->findAll()]);
    }
    ...
    {
        return $this->render('training_category/show.html.twig', ['training_category' => $trainingCategory]);
    }
    ...
    public function edit(Request $request, TrainingCategory $trainingCategory): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('training_category_edit', ['id' => $trainingCategory->getId()]);
        }
